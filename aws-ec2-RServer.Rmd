...
(5) I specified the path of the git clone to /home/test/aws-workshop, which is where it would have been in my prior manual instance launches (note that `/home` in this case is home of the root user during the installation process, not home of the `ec2-user` we have been ssh'ing into the machine as).
