...
At this stage, you should now be able to send API calls to the CoreNLP server and receive results. There is a brief example in R below (you have to learn the Python yourself).
...
url <- "http://ec2-18-224-67-228.us-east-2.compute.amazonaws.com:9000/"
